...
function Navbar() {
    return (
        <div class="navbar bg-neutral dark:bg-slate-800">
            ...
            <div class="navbar-center">
                <a class="btn btn-ghost normal-case text-xl text-accent italic">ReAPP</a>
            </div>
            <div class="navbar-end">
                <button onClick={console.log('a')} class='btn btn-ghost btn-circle'>
